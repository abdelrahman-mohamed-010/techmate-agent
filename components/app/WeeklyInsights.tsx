...
export default function WeeklyInsights() {
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
      <div className="mb-6">
    ...
    <Card className="p-4 border border-gray-200 dark:border-gray-700">
      <div className="flex items-start gap-3">
        <div className="rounded-full bg-gray-50 dark:bg-gray-700 p-2">
          <Lightbulb className="h-5 w-5 text-gray-400 dark:text-gray-300" />
        </div>
        <div>
      ...
      <div className="flex justify-end mt-6 gap-2">
        ...
        >
          <ThumbsUp className="h-5 w-5 text-gray-400 dark:text-gray-300" />
        </button>
        <button
          className="p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          aria-label="Thumbs down"
        >
          <ThumbsDown className="h-5 w-5 text-gray-400 dark:text-gray-300" />
        </button>
      </div>
    </Card>
  );
