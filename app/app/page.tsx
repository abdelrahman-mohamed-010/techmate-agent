...
export default function TechMatePanel() {
  return (
    <div className="flex h-screen overflow-auto">
      ...
      <div className="flex-1 flex flex-col">
        <div className="p-6 pb-0 flex-none">
          ...
          <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto mb-8">
            {" "}
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center gap-3 dark:bg-gray-800">
              ...
              <Plus className="ml-auto h-5 w-5 text-muted-foreground dark:text-gray-400" />
            </div>
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center gap-3 dark:bg-gray-800">
              <div className="bg-blue-100 dark:bg-blue-900/50 rounded-full p-2">
                <Users className="h-5 w-5 text-blue-600 dark:text-blue-400" />
              </div>
              <span className="font-medium dark:text-white">Agents</span>
              <Plus className="ml-auto h-5 w-5 text-muted-foreground dark:text-gray-400" />
            </div>
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center gap-3 dark:bg-gray-800">
              <div className="bg-blue-100 dark:bg-blue-900/50 rounded-full p-2">
              ...
              <span className="font-medium dark:text-white">Magnate</span>
              <Plus className="ml-auto h-5 w-5 text-muted-foreground dark:text-gray-400" />
            </div>
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center gap-3 dark:bg-gray-800">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center gap-3 dark:bg-gray-800">
              ...
              <span className="font-medium dark:text-white ">New AI Chat</span>
              <Plus className="ml-auto h-5 w-5 text-muted-foreground dark:text-gray-400" />
            </div>
          </div>
        </div>
        ...
        <div className=" mx-12 ">
          <div className="border  border-gray-200 rounded-lg p-4">
            <div className="flex justify-between items-center mb-4 ">
              <div className="font-medium">Summarize this Document</div>
      ...
      {/* Right Sidebar */}
      <div className="w-[280px] border-l border-gray-200 dark:border-gray-700">
